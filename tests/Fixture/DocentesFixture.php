...
class DocentesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'titulacao' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-08-06 13:59:05',
                'modified' => '2018-08-06 13:59:05'
            ],
        ];
        parent::init();
    }
