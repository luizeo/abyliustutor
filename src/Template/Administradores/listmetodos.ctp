    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('Visualizar'), ['action' => 'vermetodo', $metodo->cod_metodo]) ?>
                    <?= $this->Html->link(__('Editar'), ['action' => 'editarmetodo', $metodo->cod_metodo]) ?>
                    <?= $this->Form->postLink(__('Excluir'), ['action' => 'delmetodo', $metodo->cod_metodo], ['confirm' => __('Are you sure you want to delete # {0}?', $metodo->cod_metodo)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
