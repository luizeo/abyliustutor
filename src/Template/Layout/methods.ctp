...
<html lang="pt">
	<head>
		<meta charset="utf-8" />
		<title>TUTORIAL ABYLIUS</title> <!-- Smarty - Multipurpose + Admin -->
      ...
      <!--   <= $this->Html->script('http://code.jquery.com/ui/1.10.2/jquery-ui.js') ?> -->

        <script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
        <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script>
        <?= $this->Html->script('jquery.js') ?>
		<?= $this->Html->script('jquery.quick.search.js') ?>
	   <!-- <script>
