...
<html lang="pt">
	<head>
		<meta charset="utf-8" />
		<title>SOBRE ABYLIUS</title> <!-- Smarty - Multipurpose + Admin -->
...
<!-- 
		<= this->Html->style([
    'background-image:url' => 'demo_files/images/vision-min.jpg'])?>; -->
		 <?= $this->Flash->render() ?>
         <?php include_once(WWW_ROOT . DS . "files" . DS . "aboutbar.php") ?>
         <?= $this->fetch('content')?>
